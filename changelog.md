...
- Added corrupt, mismatched, unsupported-schema, running-process, replacement-failure, sidecar, GUI, CLI, and physical-macOS copied-profile coverage for `FUT-018`; physical Windows 11 validation remains pending.
